...
from . import admin_make_correction
...
admin_router_aggregate.include_router(user_price.router)
...
admin_router_aggregate.include_router(admin_make_correction.router)
